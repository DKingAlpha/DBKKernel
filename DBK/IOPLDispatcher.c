...
void mykapc2(PKAPC Apc, PVOID NormalRoutine, PVOID NormalContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
	ULONG_PTR iswow64;
	ExFreePool(Apc);
...
void mykapc(PKAPC Apc, PVOID NormalRoutine, PVOID NormalContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
	...
	KeInitializeApc(kApc,
                    ...
                    mykapc2,
                    NULL,
                    (PVOID)*(PUINT_PTR)SystemArgument1,
                    UserMode,
